...
import { type DecodeParameters } from './types'
 ...
 */
export const decode = async (params: DecodeParameters): Promise<InstanceType<typeof QuadRenderer<typeof HalfFloatType, InstanceType<typeof GainMapDecoderMaterial>>>> => {
