...
test('renders the example correctly', async ({ page, context }, testInfo) => {
  ...
  startTime = performance.now()
  await expect(page).toHaveScreenshot('initial.png', { timeout: 240_000 })
  ...
  startTime = performance.now()
  await expect(page).toHaveScreenshot('zoomed-in.png', { timeout: 240_000 })
  ...
  startTime = performance.now()
  await expect(page).toHaveScreenshot('zoomed-out-from-above.png', { timeout: 240_000 })
